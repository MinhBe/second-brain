---
name: learn-this
description: Unified content extraction and action planning. Use when user says "learn-this <URL>", "learn this <URL>", "learn-this <book title>", "weave <URL>", "help me plan <URL>", "extract and plan <URL>", "make this actionable <URL>", or similar phrases indicating they want to extract content and create an action plan. Book titles route to book-insight; URLs retain their YouTube, article or PDF workflow.
...
Before URL detection, check whether the input names a book instead of a URL.
For example, `learn-this "Giải trí đến chết"` loads
[book-insight](../book-insight/SKILL.md) and follows its evidence-based reading
workflow to produce one `<slug>_INSIGHT.md`. Resolve author/original title/year
from supplied sources; ask only if the book identity remains ambiguous.
Do not pass a book title to article extraction or generate a second Ship-Learn-Next
file: the Book Insight report already includes applications and review dates.
If non-URL input is not identifiable as a book, clarify the intended source.
