...
Examples:
  python cost.py                                # last 7d, by day
  python cost.py --since 30d --by project
  python cost.py --since 30d --by model
  python cost.py --cwd /Volumes/T7/code/blanc   # one project, all time
  python cost.py --since 30d --by session --limit 10 --show-subagents
"""
