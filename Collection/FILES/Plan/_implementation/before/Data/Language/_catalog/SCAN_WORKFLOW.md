...
Root: `C:\Users\Admin\Documents\Language`
...
2. Run inventory:
   ...
   ```powershell
   python "C:\Users\Admin\Documents\Language\_tools\language_library_organizer.py" scan
   ```
...
4. Generate a dry-run move plan:
   ...
   ```powershell
   python "C:\Users\Admin\Documents\Language\_tools\language_library_organizer.py" plan
   ```
...
6. Apply only a conflict-free plan:
   ...
   ```powershell
   python "C:\Users\Admin\Documents\Language\_tools\language_library_organizer.py" apply --plan "<latest move_plan json>"
   ```
