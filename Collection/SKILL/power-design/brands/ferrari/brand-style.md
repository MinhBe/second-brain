...
**Website:** [https://www.ferrari.com](https://www.ferrari.com)

To extract a fresher version of this brand's design system, run the Power Design Firecrawl extractor against `https://www.ferrari.com` and replace this file with the output.
