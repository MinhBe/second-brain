...
**Website:** [https://voltagent.dev](https://voltagent.dev)

To extract a fresher version of this brand's design system, run the Power Design Firecrawl extractor against `https://voltagent.dev` and replace this file with the output.
