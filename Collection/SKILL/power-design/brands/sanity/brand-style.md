...
**Website:** [https://sanity.io](https://sanity.io)

To extract a fresher version of this brand's design system, run the Power Design Firecrawl extractor against `https://sanity.io` and replace this file with the output.
