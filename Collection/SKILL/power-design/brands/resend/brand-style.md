...
**Website:** [https://www.resend.com](https://www.resend.com)

To extract a fresher version of this brand's design system, run the Power Design Firecrawl extractor against `https://www.resend.com` and replace this file with the output.
