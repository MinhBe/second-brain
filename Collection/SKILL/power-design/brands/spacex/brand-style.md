...
**Website:** [https://www.spacex.com](https://www.spacex.com)

To extract a fresher version of this brand's design system, run the Power Design Firecrawl extractor against `https://www.spacex.com` and replace this file with the output.
