...
**Website:** [https://www.intercom.com](https://www.intercom.com)

To extract a fresher version of this brand's design system, run the Power Design Firecrawl extractor against `https://www.intercom.com` and replace this file with the output.
