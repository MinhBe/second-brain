...
**Website:** [https://www.cohere.com](https://www.cohere.com)

To extract a fresher version of this brand's design system, run the Power Design Firecrawl extractor against `https://www.cohere.com` and replace this file with the output.
