...
**Website:** [https://www.miro.com](https://www.miro.com)

To extract a fresher version of this brand's design system, run the Power Design Firecrawl extractor against `https://www.miro.com` and replace this file with the output.
