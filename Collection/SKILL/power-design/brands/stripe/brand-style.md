...
**Website:** [https://www.stripe.com](https://www.stripe.com)

To extract a fresher version of this brand's design system, run the Power Design Firecrawl extractor against `https://www.stripe.com` and replace this file with the output.
