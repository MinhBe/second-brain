...
**Website:** [https://www.shopify.com](https://www.shopify.com)

To extract a fresher version of this brand's design system, run the Power Design Firecrawl extractor against `https://www.shopify.com` and replace this file with the output.
