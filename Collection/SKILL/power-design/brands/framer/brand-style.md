...
**Website:** [https://www.framer.com](https://www.framer.com)

To extract a fresher version of this brand's design system, run the Power Design Firecrawl extractor against `https://www.framer.com` and replace this file with the output.
