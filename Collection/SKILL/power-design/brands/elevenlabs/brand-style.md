...
To extract a fresher version of this brand's design system, run the Power Design Firecrawl extractor against `https://elevenlabs.io` and replace this file with the output.
