...
**Website:** [https://claude.com](https://claude.com)

To extract a fresher version of this brand's design system, run the Power Design Firecrawl extractor against `https://claude.com` and replace this file with the output.
