...
**Website:** [https://www.mintlify.com](https://www.mintlify.com)

To extract a fresher version of this brand's design system, run the Power Design Firecrawl extractor against `https://www.mintlify.com` and replace this file with the output.
