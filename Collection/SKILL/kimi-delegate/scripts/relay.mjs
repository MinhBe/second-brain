...
function dispatchToKimi(opts, brief, run, writeResult) {
  ...
  // A grandchild that outlives kimi and inherited the pipes keeps stdout/stderr open, so
  // "close" never fires and the relay waits forever, writing no result. Once kimi itself is
