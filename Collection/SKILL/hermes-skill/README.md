...
```bash
# Check all nudges
~/self-improving/evo nudge

# Add a memory
~/self-improving/evo remember "Important knowledge to remember"

# Search memories
~/self-improving/evo search "keyword"

# Evaluate a skill
~/self-improving/evo eval "skill-name,4"

# Run full self-check
~/self-improving/evo check
```
...
# 添加记忆
~/self-improving/evo remember "要记住的重要知识"

# 搜索记忆
~/self-improving/evo search "关键词"

# 评估技能
~/self-improving/evo eval "技能名,4"
