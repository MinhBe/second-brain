 ...
 *   - browser_screenshot   write a PNG to the OS temp dir and return the path
 ...
 *   PI_BROWSER_PROFILE     override the user-data dir (default <home>/.pi/agent/extensions/browser/.profile)
 */
