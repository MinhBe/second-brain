...
function dispatchToAider(opts, run, writeResult) {
  ...
  // A grandchild that outlives aider and inherited the pipes keeps stdout/stderr open, so
  // "close" never fires and the relay waits forever, writing no result. Once aider itself is
